...
public interface LitemallAdminMapper {
     ...
     * @mbg.generated
     */
    int batchInsert(@Param("list") List<LitemallAdmin> list);
     ...
     * @mbg.generated
     */
    int batchInsertSelective(@Param("list") List<LitemallAdmin> list, @Param("selective") LitemallAdmin.Column ... selective);
}